...
\begin{document}
  ...
  \end{center}
  % When women stopped coding - \link{https://www.npr.org/sections/money/2014/10/21/357629765/when-women-stopped-coding}
  % Science doesn't explain tech's diversity problem, history does - \link{https://www.theverge.com/2017/8/16/16153740/tech-diversity-problem-science-history-explainer-inequality}
  % Fly girls: Women in Aviation - \link{https://www.youtube.com/watch?v=p12jUNsx5e0&feature=youtu.be}
  % Introduction: Solving the Equation - \link{https://www.youtube.com/watch?v=FKaOGuzhbM8#action=share}
  ...
  \begin{enumerate}
    ...
    \begin{itemize} 
      \item[] (x) % /mse/why.pdf % \link{https://www.youtube.com/watch?v=FKaOGuzhbM8#action=share}
    \end{itemize}
    ...
    \begin{itemize}
      \item[] (x) % /mse/africanWomen.pdf
    \end{itemize}
    \item \textbf{BBC Documentary: Calculating Ada The Countess of Computing.}
    \begin{itemize}
      \item[] (x) % \link{https://www.youtube.com/watch?v=QgUVrzkQgds&feature=youtu.be}
    \end{itemize}
  ...
  \end{center}
  \begin{enumerate}
    \item \imp{Elizabeth Rona} -\ (x) % \link{https://www.nytimes.com/2019/08/28/obituaries/elizabeth-rona-overlooked.html} 
    \item \imp{Leona Libby} -\
    \item \imp{Cecilia Payne-Gaposchkin} -\ (x?) % \link{https://www.aip.org/history-programs/niels-bohr-library/oral-histories/4620}
    ...
    \item \imp{Gerty Cori} -\
    \item \imp{Dorothy Crowfoot Hodgkin} -\ (x) % \link{https://www.youtube.com/watch?v=JoXdBwO-pMc&feature=youtu.be} \link{https://www.youtube.com/watch?v=zrryPaMnGVs&feature=youtu.be} \link{https://www.youtube.com/channel/UCV2K5lz8l63hAOxbEBsEMrA}
    ...
    \item \imp{Sally Ride} -\ (x) % \link{https://sallyridescience.ucsd.edu/about/sallyride/about-sallyride/}
    \item \imp{Rachel Carson} -\ (x) % /mse/rachelCarson.txt % \link{https://www.youtube.com/watch?v=Ipbc-6IvMQI&feature=youtu.be}
    \item \imp{Hedy Lamarr} -\ (x) % /mse/hedyLamarr.txt % \link{https://www.pbs.org/newshour/show/the-brilliant-mind-of-hollywood-legend-hedy-lamarr}
    \item \imp{Grace Hopper} -\ (!x) % site not working
    \item \imp{Ada Lovelace} -\ (x) % \link{https://www.theguardian.com/science/sifting-the-evidence/2015/oct/13/why-ada-lovelace-day-matters}
    ...
    \item \imp{Ellen Ochoa} -\ (x) % \link{https://www.youtube.com/watch?v=ZnMYy_wHk1s&feature=youtu.be}
    \item \imp{Edith Clark} -\ (x) % \link{https://www.youtube.com/watch?v=Q8JQN7t_SeI&feature=youtu.be}
  \end{enumerate}
\end{document}