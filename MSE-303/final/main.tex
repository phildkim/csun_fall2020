...
\begin{document}
  ...
  \begin{enumerate}
    ...
    \begin{itemize} 
      \item \red{X} \href{https://www.cbs.com/shows/60_minutes/video/YPhAPrmoPNXU6EEPdRzkbcRP7oM_1RuR/grace-hopper-she-taught-computers-to-talk/}{\warn{Grace Hopper Segment on 60 minutes}}
      \item \href{https://www.youtube.com/watch?v=01ZrwW9C5z0}{\warn{Cathy Wolf, Human-Computer Inter. Pioneer}}
      \item \imp{Madame Curie Complex: The Hidden History of Women in Science}
      \item \imp{Women's Contribution to ENIAC Remembered} -\ \warn{/mse/txt/eniac.txt}
      \item \dne{Women's contributions to the National Bureau of Standards.}
      \item \href{https://www.npr.org/sections/money/2014/10/21/357629765/when-women-stopped-coding}{\warn{When women stopped coding}}
      \item \href{https://www.theverge.com/2017/8/16/16153740/tech-diversity-problem-science-history-explainer-inequality}{\warn{Science doesn't explain tech's diversity problem, history does}}
      \item \href{https://www.aauw.org/resources/research/the-stem-gap/}{\warn{Why so few? Women in Science, Tech, Engn. and Math}} % /mse/why.pdf
      ...
      \item \href{https://www.theguardian.com/science/sifting-the-evidence/2015/oct/13/why-ada-lovelace-day-matters}{\warn{Why Ada Lovelace Day Matters}}
      \item \href{https://web.archive.org/web/20170312212947/http:/www.doublexscience.org/the-finkbeiner-test/}{\warn{The Finkbeiner Test, Double X Science}}
      \item \href{https://publiceditor.blogs.nytimes.com/2013/04/01/gender-questions-arise-in-obituary-of-rocket-scientist-and-her-beef-stroganoff/}{\warn{Gender Questions Arise in Obituary \& her Beef Stronganoff}}
    \end{itemize}
  ...
  \begin{enumerate}
    ...
    \item \href{https://ncses.nsf.gov/pubs/nsf19304/digest}{\warn{National Science foundation}}
    \item \href{https://www.usatoday.com/story/news/nation/2019/10/18/nasa-astronauts-international-space-station-first-all-female-spacewalk/4020056002/}{\warn{2 astronauts made history in nasa first all female spacewalk}}
  \end{enumerate}
  ...
  \end{center}
  \begin{enumerate}
    \item \imp{Elizabeth Rona} -\ \warn{/mse/txt/elizabethRona.txt}
    \item \dne{Leona Libby} -\
    \item \imp{Cecilia Payne-Gaposchkin} -\ \href{https://www.aip.org/history-programs/niels-bohr-library/oral-histories/4620}{\warn{Cecilia Payne-Gaposchkin}}
    \item \imp{Maria Goeppert Mayer} -\ \warn{/mse/pdf/rosalindFranklin.pdf}
    ...
    \item \imp{Maria Mayer} -\ \warn{/mse/pdf/rosalindFranklin.pdf}
    \item \dne{Gerty Cori} -\
    ...
    \item \imp{Rosalind Franklin} -\ \warn{/mse/pdf/rosalindFranklin.pdf}
    \item \imp{Rosalyn Sussman Yalow} -\ \warn{/mse/pdf/rosalynSussman.pdf}
    \item \dne{Fay Ajzenberg-Selove's} -\
    \item \imp{Barbara McClintock} -\ \warn{/mse/pdf/rosalindFranklin.pdf}
    \item \imp{Jane Goodall} -\ \warn{/mse/pdf/janeDiane.pdf}
    \item \imp{Diane Fossey} -\ \warn{/mse/pdf/janeDiane.pdf}
    \item \imp{Birute Galdikas} -\ \warn{/mse/pdf/janeDiane.pdf}
    ...
    \item \imp{Sally Ride} -\ \warn{/mse/txt/sallyRide.txt}
    \item \imp{Rachel Carson} -\ DDT, pesticides that was harmful to humans but still used because of lack of acknowledgement. Rachel Carson discovered that it was very harmful for humans which turned into her writing ``Silent Spring''.  \warn{/mse/txt/rachelCarson.txt}
    \item \imp{Hedy Lamarr} -\ \red{X} \href{https://www.pbs.org/newshour/show/the-brilliant-mind-of-hollywood-legend-hedy-lamarr}{\warn{pbs}} \imp{\&} \warn{/mse/txt/hedyLamarr.txt} 
    \item \dne{Grace Hopper} -\
    \item \imp{Ada Lovelace} -\ \warn{/mse/txt/adaLovelace.txt}
    ...
    \item \imp{Catherine Wolf} -\ A pioneering psychologist in the field of human-computer interaction, has been living with amyotrophic lateral sclerosis (ALS, or Lou Gehrig's disease) for 20 years. She invented first gesture-based system for collaboration called We Met.
